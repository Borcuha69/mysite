$(document).ready(function(){
    ...
    function calculatingBasketPrice() {
        ...
        $('.product-in-basket-total-price').each(function () {
            order_total_price += parseFloat($(this).text());
        });
        $('#order_total_price').text(order_total_price.toFixed(2));
    };
    ...
    $(document).on('change', ".product-in-basket-nmb", function () {
        ...
        var total_price = parseFloat(current_nmb * current_price).toFixed(2);
        current_tr.find('.product-in-basket-total-price').text(total_price);
